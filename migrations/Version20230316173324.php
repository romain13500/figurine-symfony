 ...
 */
final class Version20230316173324 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE purchase_figurines (purchase_id INT NOT NULL, figurines_id INT NOT NULL, INDEX IDX_C09519AA558FBEB9 (purchase_id), INDEX IDX_C09519AA6DD12435 (figurines_id), PRIMARY KEY(purchase_id, figurines_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
